            ...
            <div
                ...
                <div>
                    <button
                        ...
                        <img class="h-8 rounded-full" src="{{ asset('assets/images/logo.png') }}" alt="">
                        {{--                                <span class="ml-3 hidden text-sm font-medium text-gray-700 lg:block"><span class="sr-only">Open user menu for </span>Trast Muamalat</span>--}}
                ...
                <div
                    ...
                    <a wire:click="logout" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">Выход</a>
                </div>
            </div>
        </div>
    </div>
